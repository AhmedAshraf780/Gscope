interface AnalyticsPaneProps {
  analysis: import("./types").BasicAnalysis | null;
}

export function AnalyticsPane(_props: AnalyticsPaneProps) {
  return (
        ...
        <div className="grid gap-5">
          ...
          <article className="rounded-[1.75rem] border border-white/10 bg-[#09111d] p-5">
            ...
            <div className="mt-4 space-y-3 text-sm leading-7 text-[var(--muted)]">
              <p>
                Peak occupancy is holding between 6 PM and 8 PM on weekdays.
              </p>
              <p>
                Boxing packages are converting better than standard session
                packs.
              </p>
              <p>
                Expired memberships need follow-up before the next billing
                cycle.
              </p>
            </div>
          </article>
